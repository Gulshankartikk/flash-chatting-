...
const NotificationPanel = ({
  ...
  return (
    <div className="fixed inset-y-0 right-0 w-80 md:w-96 bg-[#111111] border-l border-[#222222] shadow-2xl z-45 flex flex-col animate-slide-in-left">
      {/* Header */}
      <div className="flex items-center justify-between p-4 border-b border-[#222222]">
        ...
        <button
          onClick={onClose}
          className="p-1 hover:bg-[#1c1c1c] rounded-full text-[#A0A0A0] hover:text-[#FFFFFF] transition-colors"
        >
          <X size={18} />
        </button>
      </div>
      ...
      {notifications.length > 0 && (
        <div className="flex justify-between items-center px-4 py-2 bg-[#000000] border-b border-[#222222]">
          <button
      ...
      <div className="flex-1 overflow-y-auto divide-y divide-[#222222]">
        {notifications.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-20 text-center text-[#A0A0A0]">
          ...
          notifications.map((notif) => (
            <div
              ...
              className={`p-4 flex gap-3 transition-colors ${
                notif.read ? "bg-[#111111]" : "bg-[#1c1c1c]"
              }`}
            >
              {notif.avatar ? (
                <img
              ...
              <div className="flex-1 text-left min-w-0">
                ...
                <p className="text-[11px] text-[#A0A0A0] mt-0.5 break-words">
              ...
              <button
                ...
                className="p-1 hover:bg-[#222222] rounded text-[#A0A0A0] hover:text-[#FF9E00] transition-colors self-start"
              >
                <Trash2 size={13} />
              </button>
            </div>
