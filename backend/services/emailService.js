...
const transporter = nodemailer.createTransport({
  ...
  auth: {
    ...
    pass: process.env.EMAIL_PASS, // ✅ lowercase
  },
});
...
const sendOtpToEmail = async (email, otp) => {  // ✅ fixed syntax
  const html = `
  ...
  await transporter.sendMail({
    from: `Flash Chat Web <${process.env.EMAIL_USER}>`,
    to: email,
...
module.exports = sendOtpToEmail; // ✅ export function
